...
/**
 * la classe ListaStudentiTutor permette di vedere la lista degli studenti accettati dall'azienda
 *
 */
public class ListaStudentiTutor {
	/**
	 * Metodo che permette al tutor di accettare la richiesta di uno studente accettata dall'azienda
	 * @return
	 * @throws SQLException
	 */
