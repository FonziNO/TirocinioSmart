<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	import="java.util.ArrayList" import="storage.Azienda"
	import="application.ListaAziende" pageEncoding="ISO-8859-1"%>
...
<body>
	...
	<div id="sidebar" class="nav-collapse ">
		...
		<ul class="sidebar-menu" id="nav-accordion">
			...
			<p class="centered">
				<a href="Dashboard"><img src="image/Student-icon.png"
				...
				<table class="table table-bordered table-striped table-condensed">
					...
					<tbody>
						<tr>
							...
							<td><a href="DettagliAzienda1.jsp" class="btn btn-theme"
								style="margin-right: 20%" value="Dettagli">Dettagli</a></td>
						</tr>
						<tr>
							<td><%=lista.get(1).getNomeA()%></td>
							<td><a href="DettagliAzienda2.jsp" class="btn btn-theme"
								style="margin-right: 20%" value="Dettagli">Dettagli</a></td>
						</tr>
						<tr>
							<td><%=lista.get(2).getNomeA()%></td>
							<td><a href="DettagliAzienda3.jsp" class="btn btn-theme"
								style="margin-right: 20%" value="Dettagli">Dettagli</a></td>
						</tr>
					</tbody>
				</table>
